  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: PieChart(
          ...
          sectionsSpace: 0.5,
          sections: [
            PieChartSectionData(value: 35, color: Colors.green, radius: 100),
            PieChartSectionData(value: 40, color: Colors.blue, radius: 100),
            PieChartSectionData(value: 55, color: Colors.redAccent, radius: 100),
